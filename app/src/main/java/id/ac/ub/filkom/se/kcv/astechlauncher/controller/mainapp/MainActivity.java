...
public class MainActivity extends AppCompatActivity implements Medis.OnFragmentInteractionListener,
                                                               Food.OnFragmentInteractionListener,
                                                               Forecast.OnFragmentInteractionListener,
                                                               Sentiment.OnFragmentInteractionListener
{
    @Override
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        FragmentPagerItemAdapter adapter = new FragmentPagerItemAdapter(
                getSupportFragmentManager(), FragmentPagerItems.with(this)
                                                               ...
                                                               .add("App Forecast", Forecast.class)
